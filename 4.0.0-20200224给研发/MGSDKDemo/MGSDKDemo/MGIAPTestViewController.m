...
- (void)viewDidLoad {
    ...
    //询问哪些商品能够购买 //设置代理
    [[MGManager defaultManager]MGIAPStartRequestProductsArray:@[@"com.kingnet.gundam.6",
...
-(void)BuyProduct:(MGIAPModel *)product{
    ...
    [[MGManager defaultManager]MGBuyProduct:product withBuyModel:buyModel];
}
